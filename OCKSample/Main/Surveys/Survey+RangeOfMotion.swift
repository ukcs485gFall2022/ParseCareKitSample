...
extension Survey {
    ...
    static func rangeOfMotion() -> ORKTask {

        let rangeOfMotionOrderedTask = ORKOrderedTask.kneeRangeOfMotionTask(
            withIdentifier: Self.rangeOfMotion.identifier(),
            limbOption: .left,
            intendedUseDescription: nil,
            options: [.excludeConclusion]
        )

        let completionStep = ORKCompletionStep(identifier: "\(Self.rangeOfMotion.identifier()).completion")
    ...
    static func extractAnswersFromRangeOfMotionSurvey(
